...
NOTE: THIS WORKS FINE ON BACKTEST BUT FAILS COMPLETELY WHEN BACKTESTING. IE TRAIN UNTIL 2024, APPLY TO 2025... MISSES ALMOST ALL BOTTOMS OR CONFIDENCE IS BELOW 0.4. IT IS ONLY A SHOWCASE ON HOW TO USE ML. DO NOT USE FOR LIVE SIGNAL GENERATION. IT WILL FAIL GLORIOUSLY. I EXPECTED MORE ON ML. MORE USABILITY, MORE PRECISION. IF YOU USE ML, LIKE RANDOMFOREST, USE IT ONLY AS A SIGNAL-FILTER. GATE-KEEPING.
