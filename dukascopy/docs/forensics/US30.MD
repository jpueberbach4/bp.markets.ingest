...
When you have made some changes, ```./rebuild-resample.sh```, dump data with --mt4 again, reload file in beyond compare. Repeat.
...
The dates? Set them all to dates on a Saturday or Sunday. The switches below all happen over-weekend, except the last one. Keep it simple.
