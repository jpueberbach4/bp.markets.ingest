...
Drag us30_*.csv to left side of the screen, drag the MT4 export to right side of screen.

Constructing the config below took me about 45 minutes. So 45 minutes to get 7 years of data in order with MT4.

Gladly, the underlying DST/STD shifts at the MT4-end are in order for this asset.
