...
```sh
 ./build-csv.sh --select USA30.IDX-USD:adjusted:skiplast/1m,1h,4h --select DEU.IDX-EUR:adjusted:skiplast/1h,4h --select BRENT.CMD-USD:adjusted:skiplast/1h,4h --select GAS.CMD-USD:adjusted:skiplast/1h,4h --output test.csv
Running Dukascopy PARQUET/CSV exporter (16 processes)
Step: Extract...
  0%|                                                                                                                                                                                 | 0/9 [00:00<?, ?files/s]
Warning: adjusted modifier set for GAS.CMD-USD. Handling rollover gaps...
Warning: adjusted modifier set for BRENT.CMD-USD. Handling rollover gaps...
Warning: adjusted modifier set for USA30.IDX-USD. Handling rollover gaps...
Warning: adjusted modifier set for DEU.IDX-EUR. Handling rollover gaps...
Warning: adjusted modifier set for USA30.IDX-USD. Resampling...
Warning: adjusted modifier set for DEU.IDX-EUR. Resampling...
Warning: adjusted modifier set for GAS.CMD-USD. Resampling...
Warning: adjusted modifier set for BRENT.CMD-USD. Resampling...
100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 9/9 [00:36<00:00,  4.06s/files]
Merging data/temp/builder/csv/13c2f0a2-2a3a-4851-a458-8c115f23ba1b/temp to test.csv...
Cleaned up temporary directory: data/temp/builder/csv/13c2f0a2-2a3a-4851-a458-8c115f23ba1b/temp

Export complete!
Total runtime: 38.83 seconds (0.65 minutes)
```

Expect +- this performance, give or take a few seconds. Up until your number of cores, wall-time will not change much.
