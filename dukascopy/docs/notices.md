...
On that last red-candle close, the signal become 0.000009, on the live candle its 0.000029. Would i have traded the signal? Likely (support, potential double bottom, volume). But this gives a glimpse on how this works on the live-edge. Still: it is not the ONLY signal you should trade on. Thats why: permission filter. Signal? -> go look.
