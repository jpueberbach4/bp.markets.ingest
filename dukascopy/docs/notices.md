...
```sh
 ./build-csv.sh --select USA30.IDX-USD:adjusted:skiplast/1m,1h,4h --select \
 DEU.IDX-EUR:adjusted:skiplast/1h,4h --select BRENT.CMD-USD:adjusted:skiplast/1h,4h \
 --select GAS.CMD-USD:adjusted:skiplast/1h,4h --output test.csv
