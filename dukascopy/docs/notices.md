...
- So what's the plan now you achieved 86 percent accuracy? `Broader tests on more assets. Seeing if the approach works from commodities/stocks/indices (today tests)`
