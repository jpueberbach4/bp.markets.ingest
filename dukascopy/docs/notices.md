...
Note: Kinematics will get replaced with selective RNN. Do not use Kinematics. It is still working but just dont use it. RNN is smarter approach. Kinematics deprecated. Dual support for NN and TFT is also under consideration. 
