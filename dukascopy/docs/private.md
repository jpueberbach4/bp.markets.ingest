...
The stable repo will be released under the same MIT license, so feel free to fork, modify, or build commercial tools on top — no strings attached.

Thank you to everyone who cloned, tested, starred or gave feedback — the traction (~4,500 unique cloners in just a few weeks) has been unreal and very motivating.
