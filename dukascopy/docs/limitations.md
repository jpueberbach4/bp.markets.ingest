...
We cannot get it 100% exact for forex and commodities. Indices, we are near exact (note: limited sampling results). Multiplication factor per symbol needs to get supported. This will become feature-014.
