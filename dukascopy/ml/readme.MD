...
- One result absolutely requires forward testing (see the signals.gif in images folder)
...
- **Advice:** check all models scoring F1 between 0.30 and 0.44 with the `example-ml-pt` indicator. Lower F1 may actually be better.
