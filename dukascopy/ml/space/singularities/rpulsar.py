...
class RPulsarSingularity(Singularity):
    ...
    def save_state(self, universe: Any, filename: str, winner_idx: Optional[int] = None) -> None:
        ...
        Requires a pending save flag triggered during `run_generation`.
        Automatically handles genome deduplication mapping before serialization
        to ensure lean disk footprint.

        Args:
            universe (Any): The environment handling disk ejection.
            filename (str): The target file path.
            winner_idx (Optional[int]): Explicit override for the champion index.
        """
        ...
        # Utilize metrics cached during the evaluation phase
        ...
        # Reset flag to prevent redundant writes
        self._pending_save = False
        ...
        # Deduplicate active genes sequentially to preserve mathematical layout
        unique_winner_genes = []
        seen = set()
        ...
        # Construct the frozen artifact state
        state = {
        ...
        # Embed normalization statistics if operating within a Redshift universe
